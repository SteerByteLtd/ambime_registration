...
from main.backends.admin_approval.views import RegistrationView
from main.models import SupervisedRegistrationProfile
from main.users import UserModel


@override_settings(ROOT_URLCONF='ambime.urls_admin_approval')
