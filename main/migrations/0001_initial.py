    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('landline1', models.CharField(blank=True, max_length=30)),
                ('network_provider1', models.CharField(blank=True, choices=[('', 'None'), ('vodafone', 'VODAFONE'), ('gsm', 'GSM')], default='', max_length=10)),
                ('landline2', models.CharField(blank=True, max_length=30)),
                ('network_provider2', models.CharField(blank=True, choices=[('', 'None'), ('vodafone', 'VODAFONE'), ('gsm', 'GSM')], default='', max_length=10)),
