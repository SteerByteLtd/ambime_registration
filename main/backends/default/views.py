    ...
    * The creation of the templates
    ...
    def register(self, form):
        ...
        if hasattr(form, 'save'):
            ...
            new_user_instance.username = form.cleaned_data['username']
            new_user_instance.first_name = form.cleaned_data['first_name']
            new_user_instance.last_name = form.cleaned_data['last_name']
            new_user_instance.email = form.cleaned_data['email']
            new_user_instance.landline1 = form.cleaned_data['landline1']
            new_user_instance.network_provider1 = form.cleaned_data['network_provider1']
            new_user_instance.landline2 = form.cleaned_data['landline2']
            new_user_instance.network_provider2 = form.cleaned_data['network_provider2']
            new_user_instance.referred_by = form.cleaned_data['referred_by']
            new_user_instance.set_password(form.cleaned_data['password1'])

            # Increase referral_count of referred user
            referred_by = User.objects.filter(email=form.cleaned_data['referred_by']).first().id
            refer_user = User.objects.filter(id=referred_by).first()
            refer_user.referral_count += 1
            refer_user.save()
        else:
